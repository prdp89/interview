...
public class PasswordCracker {
    ...
    //This solution is diff. and need better solution. Though it pass all test case.
    private static String[] passwords;
    private static HashSet tried;
    ...
    private static String passwordCracker( String[] pass, String attempt ) {
        ...
        tried = new HashSet();
        ArrayList result = getPasswordsCombinations(new ArrayList(), new StringBuilder(), attempt);
    ...
    private static ArrayList<Integer> getPasswordsCombinations( ArrayList<Integer> currentResult
            , StringBuilder currentAttempt
            , String attempt ) {
