...
public class EditDistance {
    ...
    public static void main( String[] args ) {
        ...
        System.out.println(editDisatnce.findMinOperations("bat", "but")); //op = 1

        System.out.println(editDisatnce.findMinOperations_2D_DP("bat", "but")); //op = 1
    }
    ...
    public int findMinOperations_2D_DP( String s1, String s2 ) {
