...
public class MaxRibbonCut {
    ...
    public static void main( String[] args ) {
        ...
        System.out.println(cr.countRibbonPieces_2D_DP(ribbonLengths, 5));
    }
    ...
    public int countRibbonPieces_2D_DP( int[] ribbonLengths, int total ) {
    ...
    //1D DP solution will be equals to : CoinChangeMin ->com.interview.leetcode.dp.grokkingdp.unboundedknapscaktype
}
