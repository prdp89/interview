...
public class TwoStringInterleavingToFormThird {
    ...
    public static void main( String args[] ) {
        String str1 = "XXYM";
        String str2 = "XXZT";
        String str3 = "XXXZXYTM"; // "X X X Z X Y T M"
        ...
        System.out.println(sti.isInterleavedRecursive(str1.toCharArray(), str2.toCharArray(), str3.toCharArray(), 0, 0, 0));
    }

    private boolean isInterleavedRecursive( char str1[], char str2[], char str3[], int pos1, int pos2, int pos3 ) {
    ...
    private boolean isInterleaved( char str1[], char str2[], char str3[] ) {
        ...
        //if str3[i+j] == str1[i] then T[i][j] = T[i-1][j]
        //else if str3[i+j] == str[j] then T[i][j] = T[i][j-1]
        //else false
