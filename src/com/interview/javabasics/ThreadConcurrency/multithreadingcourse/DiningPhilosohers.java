...
public class DiningPhilosohers {

    public static void main( String[] args ) throws InterruptedException {
        DiningPhilosophersImpl.runTest();
    }

    static class DiningPhilosophersImpl {
        ...
        static void startPhilosoper( DiningPhilosophersImpl dp, int id ) {
            try {
        ...
        public static void runTest() throws InterruptedException {
            final DiningPhilosophersImpl dp = new DiningPhilosophersImpl();
